/**
 * This code is an extension of the irrlicht engines camera system,
 * it is a library extension and we are using it to control our camera.
 * It is licensed under the MIT license and hasn't made it's way into the
 * mainline branch of the graphics engine we are using yet and so I have
 * included it. I don't claim to have written it. You can find the source
 * and the multiple authors on the Irrlicht Wiki.
 */
